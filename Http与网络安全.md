- [跨域](#跨域)
  - [（1）CORS](#1cors)
  - [（2）Jsonp](#2jsonp)
  - [（2）document.domain](#2documentdomain)
  - [（3）图像Ping](#3图像ping)
  - [（5）Comet](#5comet)
  - [（6）WebSocket](#6websocket)
  - [（7）postMessage](#7postmessage)
- [CSRF攻击](#csrf攻击)
- [http和https](#http和https)
  - [混合加密：机密性](#混合加密机密性)
  - [摘要算法：完整性](#摘要算法完整性)
  - [数字签名：身份认证+不可否定](#数字签名身份认证不可否定)
- [HTTP2.0与1.1](#http20与11)
- [计算机网络五层体系结构](#计算机网络五层体系结构)
- [TCP与UDP](#tcp与udp)
- [TCP三次握手与四次挥手](#tcp三次握手与四次挥手)
  - [三次握手](#三次握手)
  - [四次挥手](#四次挥手)
  - [SYN攻击（洪泛攻击）](#syn攻击洪泛攻击)
  - [为何建立连接是三次握手，而关闭连接却是四次挥手](#为何建立连接是三次握手而关闭连接却是四次挥手)
  - [为什么TIME_WAIT状态需要经过2MSL才能返回到CLOSE状态？](#为什么time_wait状态需要经过2msl才能返回到close状态)
- [http状态码](#http状态码)
- [IPV4 IPV6](#ipv4-ipv6)
- [浏览器缓存机制](#浏览器缓存机制)
- [CDN内容分发网络](#cdn内容分发网络)
